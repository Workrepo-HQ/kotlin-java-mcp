...
This tool uses tree-sitter for syntactic analysis — it does not have a type inference engine. Symbol resolution relies on import analysis and name matching rather than resolved types. See [docs/type-inference.md](docs/type-inference.md) for details on what this means in practice.
